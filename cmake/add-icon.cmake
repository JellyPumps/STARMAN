...
function(AddIcon appsources)
    ...
    if (NOT ARG_ICONS)
        message(FATAL_ERROR "No ICONS argument given to AddIcon")
    endif()
    ...
    foreach (icon ${ARG_ICONS})
        ...
        if (UNIX AND NOT APPLE)  # Linux
            if (${icon_type} STREQUAL ".png" OR ${icon_type} STREQUAL ".svg")
                set(icon_full_output ${CMAKE_CURRENT_BINARY_DIR}/${icon_name}${icon_type})
                configure_file(${icon_full} ${icon_full_output} COPYONLY)
                set(${appsources} "${${appsources}};${icon_full_output}" PARENT_SCOPE)
                install(FILES ${icon_full_output} DESTINATION share/icons)
                return()
            endif()
        endif()
